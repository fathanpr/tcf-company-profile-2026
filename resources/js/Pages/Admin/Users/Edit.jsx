...
import { ChevronLeft, User, Save, Shield, Mail, Lock, AlertCircle } from 'lucide-react';
...
export default function Edit({ user, roles }) {
    ...
    return (
        <AdminLayout title="Edit User">
            <Head title={`Edit ${user.name} - Admin TCF`} />
                    ...
                    <div className="p-8 border-b border-slate-100 bg-slate-50/50">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">Update information and roles for {user.name}.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={submit} className="p-8 space-y-6">
                        ...
                        <div className="pt-6">
                            ...
                            >
                                ...
                                {processing ? 'Updating...' : 'Save User Changes'}
                            </button>
                        </div>
                    </form>
                </div>
