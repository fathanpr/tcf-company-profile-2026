...
export default function Create() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route("admin.ads.store"), { forceFormData: true });
    };

    return (
        <AdminLayout title="Create Ad">
            <Head title="Create Ad - Admin TCF" />
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">
                                    Set poster, click URL, and active schedule.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={submit} className="p-8 space-y-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                placeholder="E.g. Promo Dies Maintenance"
                                required
                            />
                            {errors.title && (
