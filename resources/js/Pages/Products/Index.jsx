...
export default function Index({ products, filters }) {
    ...
    const firstProductImage = String(
        products.data.length > 0
            ? getAbsoluteUrl(products.data[0].main_image)
            : getAbsoluteUrl(null),
    );
    ...
    return (
        <MainLayout>
            <Head>
                <title>
                    {__(
                        "High-Quality Automotive Products | PT Tri Centrum Fortuna",
                    )}
                </title>
                <meta
                    name="description"
                    content={__(
                        "Explore TCF's range of high-precision automotive components. From stamping to robotic welding, we provide the best Tier 2 manufacturing solutions in Indonesia.",
                    )}
                />
                <meta
                    property="og:title"
                    content={__(
                        "Our Products - Precision Automotive Components | TCF",
                    )}
                />
                <meta
                    property="og:description"
                    content={__(
                        "Discover our comprehensive range of high-quality automotive parts manufactured with robotic precision in Indonesia.",
                    )}
                />
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-slate-400 text-lg leading-relaxed">
                            {__(
                                "Explore our comprehensive range of stamped and welded components, engineered for durability and manufactured to world-class standards.",
                            )}
                        </p>
                    </motion.div>
                </div>
